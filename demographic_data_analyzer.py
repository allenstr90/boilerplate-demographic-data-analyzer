...
def calculate_demographic_data(print_data=True):
    ...
    higher_education = df[df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])]  # in list
    lower_education = df[~df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])]  # remaining degree
    ...
    top_IN_occupation = \
        df[(df['native-country'] == 'India') & (df['salary'] == '>50K')][
            'occupation'].value_counts().idxmax()  # filter count and get max
